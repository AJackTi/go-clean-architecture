...
func (_Erc20 *Erc20Caller) BalanceOfAt(opts *bind.CallOpts, account common.Address, snapshotId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "balanceOfAt", account, snapshotId)
...
//
// Solidity: function balanceOfAt(address account, uint256 snapshotId) view returns(uint256)
func (_Erc20 *Erc20Session) BalanceOfAt(account common.Address, snapshotId *big.Int) (*big.Int, error) {
	return _Erc20.Contract.BalanceOfAt(&_Erc20.CallOpts, account, snapshotId)
}

// BalanceOfAt is a free data retrieval call binding the contract method 0x4ee2cd7e.
//
// Solidity: function balanceOfAt(address account, uint256 snapshotId) view returns(uint256)
func (_Erc20 *Erc20CallerSession) BalanceOfAt(account common.Address, snapshotId *big.Int) (*big.Int, error) {
	return _Erc20.Contract.BalanceOfAt(&_Erc20.CallOpts, account, snapshotId)
}
...
// GetBurnedAmountTotal is a free data retrieval call binding the contract method 0x1ec4280a.
//
// Solidity: function getBurnedAmountTotal() view returns(uint256 _amount)
func (_Erc20 *Erc20Caller) GetBurnedAmountTotal(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "getBurnedAmountTotal")
...
//
// Solidity: function getBurnedAmountTotal() view returns(uint256 _amount)
func (_Erc20 *Erc20Session) GetBurnedAmountTotal() (*big.Int, error) {
	return _Erc20.Contract.GetBurnedAmountTotal(&_Erc20.CallOpts)
}

// GetBurnedAmountTotal is a free data retrieval call binding the contract method 0x1ec4280a.
//
// Solidity: function getBurnedAmountTotal() view returns(uint256 _amount)
func (_Erc20 *Erc20CallerSession) GetBurnedAmountTotal() (*big.Int, error) {
	return _Erc20.Contract.GetBurnedAmountTotal(&_Erc20.CallOpts)
}
...
func (_Erc20 *Erc20Caller) TotalSupplyAt(opts *bind.CallOpts, snapshotId *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "totalSupplyAt", snapshotId)
...
//
// Solidity: function totalSupplyAt(uint256 snapshotId) view returns(uint256)
func (_Erc20 *Erc20Session) TotalSupplyAt(snapshotId *big.Int) (*big.Int, error) {
	return _Erc20.Contract.TotalSupplyAt(&_Erc20.CallOpts, snapshotId)
}

// TotalSupplyAt is a free data retrieval call binding the contract method 0x981b24d0.
//
// Solidity: function totalSupplyAt(uint256 snapshotId) view returns(uint256)
func (_Erc20 *Erc20CallerSession) TotalSupplyAt(snapshotId *big.Int) (*big.Int, error) {
	return _Erc20.Contract.TotalSupplyAt(&_Erc20.CallOpts, snapshotId)
}
...
func (_Erc20 *Erc20Transactor) Snapshot(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "snapshot")
}

// Snapshot is a paid mutator transaction binding the contract method 0x9711715a.
//
// Solidity: function snapshot() returns()
func (_Erc20 *Erc20Session) Snapshot() (*types.Transaction, error) {
	return _Erc20.Contract.Snapshot(&_Erc20.TransactOpts)
}

// Snapshot is a paid mutator transaction binding the contract method 0x9711715a.
//
// Solidity: function snapshot() returns()
func (_Erc20 *Erc20TransactorSession) Snapshot() (*types.Transaction, error) {
	return _Erc20.Contract.Snapshot(&_Erc20.TransactOpts)
}
...
// Erc20SnapshotIterator is returned from FilterSnapshot and is used to iterate over the raw logs and unpacked data for Snapshot events raised by the Erc20 contract.
type Erc20SnapshotIterator struct {
	Event *Erc20Snapshot // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *Erc20SnapshotIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *Erc20SnapshotIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *Erc20SnapshotIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// Erc20Snapshot represents a Snapshot event raised by the Erc20 contract.
...
func (_Erc20 *Erc20Filterer) FilterSnapshot(opts *bind.FilterOpts) (*Erc20SnapshotIterator, error) {

	logs, sub, err := _Erc20.contract.FilterLogs(opts, "Snapshot")
	if err != nil {
		return nil, err
	}
	return &Erc20SnapshotIterator{contract: _Erc20.contract, event: "Snapshot", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Snapshot(uint256 id)
func (_Erc20 *Erc20Filterer) WatchSnapshot(opts *bind.WatchOpts, sink chan<- *Erc20Snapshot) (event.Subscription, error) {

	logs, sub, err := _Erc20.contract.WatchLogs(opts, "Snapshot")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(Erc20Snapshot)
				if err := _Erc20.contract.UnpackLog(event, "Snapshot", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Snapshot(uint256 id)
func (_Erc20 *Erc20Filterer) ParseSnapshot(log types.Log) (*Erc20Snapshot, error) {
	event := new(Erc20Snapshot)
	if err := _Erc20.contract.UnpackLog(event, "Snapshot", log); err != nil {
		return nil, err
	}
